...
FEATURE_CATALOG: tuple[FeatureSpec, ...] = (
    ...
    FeatureSpec(
        ...
        description="Price/earnings multiple implied by the offering price — needs reported net income.",
        required_source_fields=("kap_extraction.reported_net_income",),
        acceptable_sources=_PROSPECTUS_AND_ANNOUNCEMENT,
        offer_timing="pre_offer",
        is_mandatory=False,
        availability_kind="direct",
    ...
    FeatureSpec(
        ...
        required_source_fields=("kap_extraction.oversubscription_ratio",),
